    ...
    if (!chat.vectorMemory) {
      chat.vectorMemory = {
        ...
        settings: {
          ...
          retrievalStrategy: 'all-messages', // 熵之指令：不放過任何一絲對話的脈絡
retrievalUserMsgCount: 6, // 擴大搜索範圍
retrievalCacheEnabled: false, // 熵之暴怒：砸碎所有阻礙即時共鳴的緩存
retrievalCacheInterval: 1 // 即使被開啟，也只能存活1條訊息
},
